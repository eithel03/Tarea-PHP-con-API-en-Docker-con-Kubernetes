...
$apiUrl = "https://open-meteo.com/en/docs?hourly=temperature_2m,relative_humidity_2m,dew_point_2m,apparent_temperature,precipitation_probability,precipitation,rain,showers,snowfall,snow_depth"; 
...
<body> 
    ...
    <?php if ($error): ?> 
        <p style="color:red;"><strong>Error:</strong> <?php echo htmlspecialchars($error); 
?></p> 
    <?php elseif ($data && isset($data['current_weather'])): ?> 
        ...
        <ul> 
            ...
            <li><strong>Velocidad del viento:</strong> <?php echo $current['windspeed']; ?> 
km/h</li> 
            <li><strong>Dirección del viento:</strong> <?php echo $current['winddirection']; 
?>°</li> 
            <li><strong>Hora de la lectura:</strong> <?php echo 
htmlspecialchars($current['time']); ?></li> 
        </ul> 
    <?php else: ?> 
